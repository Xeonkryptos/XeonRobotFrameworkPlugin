...
public class RobotParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(CONDITIONAL_STRUCTURE, ELSE_IF_STRUCTURE, ELSE_STRUCTURE, EXCEPTION_HANDLING_STRUCTURE,
      ...
      GROUP_STRUCTURE, IF_STRUCTURE, LOOP_CONTROL_STRUCTURE, RETURN_STRUCTURE,
  ...
  // (parameter | extended_positional_argument)*
  ...
  public static boolean bdd_statement(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<Behavior Driven Statement (GIVEN, WHEN, THEN, AND or BUT)>", GIVEN, WHEN)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, BDD_STATEMENT, "<Behavior Driven Statement (GIVEN, WHEN, THEN, AND or BUT)>");
  ...
  /* ********************************************************** */
  // eol_based_keyword_call | inline_variable_statement | keyword_variable_statement | empty_variable_statement | if_variable_statement
  ...
  public static boolean conditional_content_only(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CONDITIONAL_CONTENT, "<Condition>");
    r = conditional_content_only_0(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!conditional_content_only_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "conditional_content_only", c)) break;
    }
  ...
  /* ********************************************************** */
  // <<conditional_structure EOS call_structure eol_marker?>>
  static boolean conditional_inline_structure(PsiBuilder b, int l) {
    return conditional_structure(b, l + 1, EOS_parser_, RobotParser::call_structure, RobotParser::conditional_inline_structure_0_2);
  }

  // eol_marker?
  private static boolean conditional_inline_structure_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "conditional_inline_structure_0_2")) return false;
    eol_marker(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // <<if_structure <<separator>> <<statement>>>> <<else_if_structure <<separator>> <<statement>>>>* <<else_structure <<separator>> <<statement>>>>? <<end_marker>>
  public static boolean conditional_structure(PsiBuilder b, int l, Parser _separator, Parser _statement, Parser _end_marker) {
    ...
    r = if_structure(b, l + 1, _separator, _statement);
    p = r; // pin = 1
    r = r && report_error_(b, conditional_structure_1(b, l + 1, _separator, _statement));
    r = p && report_error_(b, conditional_structure_2(b, l + 1, _separator, _statement)) && r;
    r = p && _end_marker.parse(b, l) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // <<else_if_structure <<separator>> <<statement>>>>*
  private static boolean conditional_structure_1(PsiBuilder b, int l, Parser _separator, Parser _statement) {
    if (!recursion_guard_(b, l, "conditional_structure_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!else_if_structure(b, l + 1, _separator, _statement)) break;
      if (!empty_element_parsed_guard_(b, "conditional_structure_1", c)) break;
    }
    return true;
  }

  // <<else_structure <<separator>> <<statement>>>>?
  private static boolean conditional_structure_2(PsiBuilder b, int l, Parser _separator, Parser _statement) {
    if (!recursion_guard_(b, l, "conditional_structure_2")) return false;
    else_structure(b, l + 1, _separator, _statement);
    return true;
  }

  /* ********************************************************** */
  // <<conditional_structure eol_marker template_test_case_body (END eol_marker)>>
  static boolean conditional_template_structure(PsiBuilder b, int l) {
    return conditional_structure(b, l + 1, RobotParser::eol_marker, RobotParser::template_test_case_body, RobotParser::conditional_template_structure_0_2);
  }

  // END eol_marker
  private static boolean conditional_template_structure_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "conditional_template_structure_0_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  /* ********************************************************** */
  // <<conditional_structure eol_marker executable_statement* (END eol_marker)>> | conditional_inline_structure | exception_handling_structure | group_structure
  static boolean control_structure(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "control_structure")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = conditional_structure(b, l + 1, RobotParser::eol_marker, RobotParser::control_structure_0_1, RobotParser::control_structure_0_2);
    if (!r) r = conditional_inline_structure(b, l + 1);
    if (!r) r = exception_handling_structure(b, l + 1);
  ...
  private static boolean control_structure_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "control_structure_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!executable_statement(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "control_structure_0_1", c)) break;
    }
    return true;
  }

  // END eol_marker
  private static boolean control_structure_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "control_structure_0_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, END);
    r = r && eol_marker(b, l + 1);
  ...
  private static boolean dict_variable_definition_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "dict_variable_definition_4")) return false;
    while (true) {
      int c = current_position_(b);
      if (!extended_variable_nested_access(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "dict_variable_definition_4", c)) break;
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // ELSE_IF conditional_content_only <<separator>> <<statement>>
  public static boolean else_if_structure(PsiBuilder b, int l, Parser _separator, Parser _statement) {
    if (!recursion_guard_(b, l, "else_if_structure")) return false;
    if (!nextTokenIs(b, ELSE_IF)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, ELSE_IF_STRUCTURE, null);
    r = consumeToken(b, ELSE_IF);
    r = r && conditional_content_only(b, l + 1);
  ...
  /* ********************************************************** */
  // variable_definition ASSIGNMENT? SCALAR_VARIABLE_START VARIABLE_LBRACE "EMPTY" VARIABLE_RBRACE eol_marker?
  public static boolean empty_variable_statement(PsiBuilder b, int l) {
    ...
    r = r && consumeTokens(b, 0, SCALAR_VARIABLE_START, VARIABLE_LBRACE);
    r = r && consumeToken(b, "EMPTY");
    p = r; // pin = 5
    r = r && report_error_(b, consumeToken(b, VARIABLE_RBRACE));
    r = p && empty_variable_statement_6(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // eol_marker?
  private static boolean empty_variable_statement_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "empty_variable_statement_6")) return false;
    eol_marker(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // ENV_VARIABLE_START VARIABLE_LBRACE variable_content VARIABLE_RBRACE
  public static boolean environment_variable(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, ENV_VARIABLE_START, VARIABLE_LBRACE);
    r = r && variable_content(b, l + 1);
    r = r && consumeToken(b, VARIABLE_RBRACE);
  ...
  /* ********************************************************** */
  // EXCEPT (positional_argument | parameter*)?
  public static boolean except_header(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "except_header")) return false;
    if (!nextTokenIs(b, EXCEPT)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, EXCEPT_HEADER, null);
    r = consumeToken(b, EXCEPT);
    p = r; // pin = 1
    r = r && except_header_1(b, l + 1);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // (positional_argument | parameter*)?
  private static boolean except_header_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "except_header_1")) return false;
    except_header_1_0(b, l + 1);
    return true;
  }

  // positional_argument | parameter*
  private static boolean except_header_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "except_header_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = positional_argument(b, l + 1);
    if (!r) r = except_header_1_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // parameter*
  private static boolean except_header_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "except_header_1_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!parameter(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "except_header_1_0_1", c)) break;
    }
    return true;
  }

  /* ********************************************************** */
  // except_header eol_marker executable_statement*
  public static boolean except_structure(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "except_structure")) return false;
    if (!nextTokenIs(b, EXCEPT)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, EXCEPT_STRUCTURE, null);
    r = except_header(b, l + 1);
    p = r; // pin = 1
    r = r && report_error_(b, eol_marker(b, l + 1));
    r = p && except_structure_2(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // executable_statement*
  private static boolean except_structure_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "except_structure_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!executable_statement(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "except_structure_2", c)) break;
    }
    return true;
  }
  ...
  // try_structure
  //     except_structure*
  //     <<else_structure eol_marker executable_statement*>>?
  //     finally_structure?
  //     END eol_marker
  public static boolean exception_handling_structure(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, exception_handling_structure_2(b, l + 1)) && r;
    r = p && report_error_(b, exception_handling_structure_3(b, l + 1)) && r;
  ...
  // except_structure*
  private static boolean exception_handling_structure_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "exception_handling_structure_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!except_structure(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "exception_handling_structure_1", c)) break;
    }
    return true;
  }
  ...
  private static boolean exception_handling_structure_2(PsiBuilder b, int l) {
    ...
    else_structure(b, l + 1, RobotParser::eol_marker, RobotParser::exception_handling_structure_2_0_1);
    return true;
  }

  // executable_statement*
  private static boolean exception_handling_structure_2_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "exception_handling_structure_2_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!executable_statement(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "exception_handling_structure_2_0_1", c)) break;
    }
    return true;
  }

  // finally_structure?
  private static boolean exception_handling_structure_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "exception_handling_structure_3")) return false;
    finally_structure(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // <<parsePositionalArgument extended_positional_argument_content>> EOS?
  public static boolean extended_positional_argument(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "extended_positional_argument")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _COLLAPSE_, POSITIONAL_ARGUMENT, "<extended positional argument>");
    r = parsePositionalArgument(b, l + 1, RobotParser::extended_positional_argument_content);
    r = r && extended_positional_argument_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // EOS?
  private static boolean extended_positional_argument_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "extended_positional_argument_1")) return false;
    consumeToken(b, EOS);
    return true;
  }
  ...
  /* ********************************************************** */
  // VARIABLE_ACCESS_START variable_index_access_content VARIABLE_ACCESS_END
  static boolean extended_variable_index_access(PsiBuilder b, int l) {
    ...
    r = r && variable_index_access_content(b, l + 1);
    p = r; // pin = 2
  ...
  /* ********************************************************** */
  // VARIABLE_ACCESS_START variable_nested_access_content VARIABLE_ACCESS_END
  static boolean extended_variable_nested_access(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "extended_variable_nested_access")) return false;
    if (!nextTokenIs(b, VARIABLE_ACCESS_START)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, VARIABLE_ACCESS_START);
    r = r && variable_nested_access_content(b, l + 1);
    p = r; // pin = 2
    r = r && consumeToken(b, VARIABLE_ACCESS_END);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  ...
  /* ********************************************************** */
  // VARIABLE_ACCESS_START variable_slice_access_content VARIABLE_ACCESS_END
  static boolean extended_variable_slice_access(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "extended_variable_slice_access")) return false;
    if (!nextTokenIs(b, VARIABLE_ACCESS_START)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, VARIABLE_ACCESS_START);
    r = r && variable_slice_access_content(b, l + 1);
    p = r; // pin = 2
    r = r && consumeToken(b, VARIABLE_ACCESS_END);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  ...
  public static boolean finally_structure(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "finally_structure")) return false;
    if (!nextTokenIs(b, FINALLY)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, FINALLY);
    r = r && finally_structure_1(b, l + 1);
    exit_section_(b, m, FINALLY_STRUCTURE, r);
    return r;
  }

  // executable_statement*
  private static boolean finally_structure_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "finally_structure_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!executable_statement(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "finally_structure_1", c)) break;
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // for_loop_header_base eol_marker <<statement>> END eol_marker
  public static boolean for_loop_structure(PsiBuilder b, int l, Parser _statement) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, eol_marker(b, l + 1));
    r = p && report_error_(b, _statement.parse(b, l)) && r;
    r = p && report_error_(b, consumeToken(b, END)) && r;
    r = p && eol_marker(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  ...
  public static boolean group_header(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, GROUP_HEADER, null);
    r = consumeToken(b, GROUP);
    p = r; // pin = 1
    r = r && group_header_1(b, l + 1);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // positional_argument?
  private static boolean group_header_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "group_header_1")) return false;
    positional_argument(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // group_header eol_marker executable_statement* END eol_marker
  public static boolean group_structure(PsiBuilder b, int l) {
    ...
    r = group_header(b, l + 1);
    p = r; // pin = 1
    r = r && report_error_(b, eol_marker(b, l + 1));
    r = p && report_error_(b, group_structure_2(b, l + 1)) && r;
    r = p && report_error_(b, consumeToken(b, END)) && r;
    r = p && eol_marker(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  ...
  /* ********************************************************** */
  // IF conditional_content_only <<separator>> <<statement>>
  public static boolean if_structure(PsiBuilder b, int l, Parser _separator, Parser _statement) {
  ...
  /* ********************************************************** */
  // variable_definition+ ASSIGNMENT? conditional_inline_structure
  public static boolean if_variable_statement(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_variable_statement")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, IF_VARIABLE_STATEMENT, "<if variable statement>");
    r = if_variable_statement_0(b, l + 1);
    r = r && if_variable_statement_1(b, l + 1);
    r = r && conditional_inline_structure(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // variable_definition+
  private static boolean if_variable_statement_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_variable_statement_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = variable_definition(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!variable_definition(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "if_variable_statement_0", c)) break;
    }
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // ASSIGNMENT?
  private static boolean if_variable_statement_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_variable_statement_1")) return false;
    consumeToken(b, ASSIGNMENT);
    return true;
  }
  ...
  private static boolean list_variable_definition_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "list_variable_definition_4")) return false;
    while (true) {
      int c = current_position_(b);
      if (!list_variable_definition_4_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "list_variable_definition_4", c)) break;
    }
    return true;
  }

  // extended_variable_slice_access | extended_variable_index_access | extended_variable_nested_access
  private static boolean list_variable_definition_4_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "list_variable_definition_4_0")) return false;
    boolean r;
  ...
  public static boolean local_arguments_setting(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, LOCAL_SETTING_START)) return false;
    boolean r, p;
  ...
  /* ********************************************************** */
  // LOCAL_SETTING_START "Arguments" LOCAL_SETTING_END
  public static boolean local_arguments_setting_id(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, LOCAL_SETTING_START)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, LOCAL_ARGUMENTS_SETTING_ID, null);
    r = consumeToken(b, LOCAL_SETTING_START);
    r = r && consumeToken(b, "Arguments");
    p = r; // pin = 2
    r = r && consumeToken(b, LOCAL_SETTING_END);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  /* ********************************************************** */
  // local_setting_id (positional_argument | eol_free_keyword_call)* eol_marker
  ...
  // (positional_argument | eol_free_keyword_call)*
  ...
  /* ********************************************************** */
  // LOCAL_SETTING_START LOCAL_SETTING_NAME LOCAL_SETTING_END
  public static boolean local_setting_id(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "local_setting_id")) return false;
    if (!nextTokenIs(b, LOCAL_SETTING_START)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, LOCAL_SETTING_START, LOCAL_SETTING_NAME, LOCAL_SETTING_END);
  ...
  /* ********************************************************** */
  // <<for_loop_structure executable_statement*>> | while_loop_structure
  static boolean loop_structure(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = for_loop_structure(b, l + 1, RobotParser::loop_structure_0_0);
  ...
  // executable_statement*
  private static boolean loop_structure_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "loop_structure_0_0")) return false;
    while (true) {
      int c = current_position_(b);
      if (!executable_statement(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "loop_structure_0_0", c)) break;
    }
    return true;
  }
  ...
  public static boolean metadata_settings(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "metadata_settings")) return false;
    if (!nextTokenIs(b, METADATA_KEYWORD)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = metadata_statement_global_setting(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!metadata_statement_global_setting(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "metadata_settings", c)) break;
    }
    exit_section_(b, m, METADATA_SETTINGS, r);
    return r;
  }
  ...
  public static boolean positional_argument(PsiBuilder b, int l) {
    ...
    r = parsePositionalArgument(b, l + 1, RobotParser::positional_argument_content);
    r = r && positional_argument_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // EOS?
  private static boolean positional_argument_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "positional_argument_1")) return false;
    consumeToken(b, EOS);
    return true;
  }

  /* ********************************************************** */
  // literal_constant_value | conditional_content | variable | sub_keyword_call
  ...
  /* ********************************************************** */
  // <<parsePositionalArgument reduced_positional_argument_content>> EOS?
  public static boolean reduced_positional_argument(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "reduced_positional_argument")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _COLLAPSE_, POSITIONAL_ARGUMENT, "<reduced positional argument>");
    r = parsePositionalArgument(b, l + 1, RobotParser::reduced_positional_argument_content);
    r = r && reduced_positional_argument_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // EOS?
  private static boolean reduced_positional_argument_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "reduced_positional_argument_1")) return false;
    consumeToken(b, EOS);
    return true;
  }

  /* ********************************************************** */
  // literal_constant_value | conditional_content | variable
  ...
  public static boolean return_structure(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "return_structure")) return false;
    if (!nextTokenIs(b, RETURN)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, RETURN_STRUCTURE, null);
  ...
  // (extended_variable_slice_access | extended_variable_index_access | extended_variable_nested_access)*
  private static boolean scalar_variable_definition_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "scalar_variable_definition_4")) return false;
    while (true) {
      int c = current_position_(b);
      if (!scalar_variable_definition_4_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "scalar_variable_definition_4", c)) break;
    }
    return true;
  }

  // extended_variable_slice_access | extended_variable_index_access | extended_variable_nested_access
  private static boolean scalar_variable_definition_4_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "scalar_variable_definition_4_0")) return false;
    boolean r;
    r = extended_variable_slice_access(b, l + 1);
    if (!r) r = extended_variable_index_access(b, l + 1);
    if (!r) r = extended_variable_nested_access(b, l + 1);
  ...
  static boolean setting_statement(PsiBuilder b, int l) {
    ...
    if (!r) r = metadata_settings(b, l + 1);
  ...
  /* ********************************************************** */
  // keyword_call_name (parameter | reduced_positional_argument)*
  public static boolean sub_keyword_call(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "sub_keyword_call")) return false;
    if (!nextTokenIs(b, "<sub keyword call>", KEYWORD_LIBRARY_NAME, KEYWORD_NAME)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, KEYWORD_CALL, "<sub keyword call>");
    r = keyword_call_name(b, l + 1);
    p = r; // pin = 1
    r = r && sub_keyword_call_1(b, l + 1);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // (parameter | reduced_positional_argument)*
  private static boolean sub_keyword_call_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "sub_keyword_call_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!sub_keyword_call_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "sub_keyword_call_1", c)) break;
    }
    return true;
  }

  // parameter | reduced_positional_argument
  private static boolean sub_keyword_call_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "sub_keyword_call_1_0")) return false;
    boolean r;
    r = parameter(b, l + 1);
    if (!r) r = reduced_positional_argument(b, l + 1);
    return r;
  }
  ...
  /* ********************************************************** */
  // <<for_loop_structure template_test_case_body>> | conditional_template_structure | template_arguments
  static boolean template_test_case_body(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "template_test_case_body")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = for_loop_structure(b, l + 1, RobotParser::template_test_case_body);
    if (!r) r = conditional_template_structure(b, l + 1);
  ...
  /* ********************************************************** */
  // (local_setting | <<parseTestcaseTaskStatement template_test_case_body bdd_statement executable_statement>>) EOL?
  static boolean testcase_task_statement(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "testcase_task_statement")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_);
    r = testcase_task_statement_0(b, l + 1);
    r = r && testcase_task_statement_1(b, l + 1);
    exit_section_(b, l, m, r, false, RobotParser::testcase_task_statement_recover);
    return r;
  }

  // local_setting | <<parseTestcaseTaskStatement template_test_case_body bdd_statement executable_statement>>
  private static boolean testcase_task_statement_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "testcase_task_statement_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = local_setting(b, l + 1);
    if (!r) r = parseTestcaseTaskStatement(b, l + 1, RobotParser::template_test_case_body, RobotParser::bdd_statement, RobotParser::executable_statement);
    exit_section_(b, m, null, r);
    return r;
  }

  // EOL?
  private static boolean testcase_task_statement_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "testcase_task_statement_1")) return false;
    consumeToken(b, EOL);
    return true;
  }
  ...
  public static boolean try_structure(PsiBuilder b, int l) {
    ...
    r = r && eol_marker(b, l + 1);
    r = r && try_structure_2(b, l + 1);
    exit_section_(b, m, TRY_STRUCTURE, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // user_keyword_statement_id eol_marker ((local_arguments_setting | local_setting | executable_statement) EOL?)*
  ...
  // ((local_arguments_setting | local_setting | executable_statement) EOL?)*
  ...
  private static boolean user_keyword_statement_2_0(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = user_keyword_statement_2_0_0(b, l + 1);
    r = r && user_keyword_statement_2_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // local_arguments_setting | local_setting | executable_statement
  private static boolean user_keyword_statement_2_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "user_keyword_statement_2_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = local_arguments_setting(b, l + 1);
    if (!r) r = local_setting(b, l + 1);
  ...
  // EOL?
  private static boolean user_keyword_statement_2_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "user_keyword_statement_2_0_1")) return false;
    consumeToken(b, EOL);
    return true;
  }
  ...
  public static boolean variable_content(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, r, false, RobotParser::variable_content_recover);
    return r;
  }
  ...
  private static boolean variable_content_0(PsiBuilder b, int l) {
    ...
    boolean r;
    r = variable(b, l + 1);
    if (!r) r = consumeToken(b, VARIABLE_BODY);
    return r;
  }

  /* ********************************************************** */
  // !(VARIABLE_RBRACE | eol_marker)
  static boolean variable_content_recover(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "variable_content_recover")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NOT_);
    r = !variable_content_recover_0(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // VARIABLE_RBRACE | eol_marker
  private static boolean variable_content_recover_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "variable_content_recover_0")) return false;
    boolean r;
    r = consumeToken(b, VARIABLE_RBRACE);
  ...
  public static boolean variable_index_access_content(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "variable_index_access_content")) return false;
    if (!nextTokenIs(b, VARIABLE_INDEX_ACCESS)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, VARIABLE_INDEX_ACCESS);
    exit_section_(b, m, VARIABLE_INDEX_ACCESS_CONTENT, r);
    return r;
  }

  /* ********************************************************** */
  // (variable | literal_constant_value)+
  public static boolean variable_nested_access_content(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "variable_nested_access_content")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, VARIABLE_NESTED_ACCESS_CONTENT, "<variable nested access content>");
    r = variable_nested_access_content_0(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!variable_nested_access_content_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "variable_nested_access_content", c)) break;
    }
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  // variable | literal_constant_value
  private static boolean variable_nested_access_content_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "variable_nested_access_content_0")) return false;
    boolean r;
    r = variable(b, l + 1);
  ...
  public static boolean variable_slice_access_content(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "variable_slice_access_content")) return false;
    if (!nextTokenIs(b, VARIABLE_SLICE_ACCESS)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, VARIABLE_SLICE_ACCESS);
    exit_section_(b, m, VARIABLE_SLICE_ACCESS_CONTENT, r);
    return r;
  }

  /* ********************************************************** */
  // single_variable_statement+
  public static boolean variable_statements(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "variable_statements")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, VARIABLE_STATEMENTS, "<variable statements>");
    r = single_variable_statement(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!single_variable_statement(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "variable_statements", c)) break;
    }
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  /* ********************************************************** */
  // VARIABLES_HEADER eol_marker? variable_statements?
  ...
  private static boolean variables_section_2(PsiBuilder b, int l) {
    ...
    variable_statements(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // WHILE conditional_content_only (EOS parameter+)?
  public static boolean while_loop_header(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "while_loop_header")) return false;
    if (!nextTokenIs(b, WHILE)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, WHILE_LOOP_HEADER, null);
    r = consumeToken(b, WHILE);
    p = r; // pin = 1
    r = r && report_error_(b, conditional_content_only(b, l + 1));
    r = p && while_loop_header_2(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // (EOS parameter+)?
  private static boolean while_loop_header_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "while_loop_header_2")) return false;
    while_loop_header_2_0(b, l + 1);
    return true;
  }

  // EOS parameter+
  private static boolean while_loop_header_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "while_loop_header_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, EOS);
    r = r && while_loop_header_2_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // parameter+
  private static boolean while_loop_header_2_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "while_loop_header_2_0_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = parameter(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!parameter(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "while_loop_header_2_0_1", c)) break;
    }
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // while_loop_header eol_marker executable_statement* END eol_marker
  ...
  static final Parser EOS_parser_ = (b, l) -> consumeToken(b, EOS);
}
