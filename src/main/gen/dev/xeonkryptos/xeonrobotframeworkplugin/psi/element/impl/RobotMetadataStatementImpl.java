...
public class RobotMetadataStatementImpl extends RobotPsiElementBase implements RobotMetadataStatement {

  public RobotMetadataStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
