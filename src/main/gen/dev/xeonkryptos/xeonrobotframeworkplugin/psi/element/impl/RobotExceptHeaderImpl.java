...
public class RobotExceptHeaderImpl extends RobotPsiElementBase implements RobotExceptHeader {

  public RobotExceptHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotVisitor visitor) {
    visitor.visitExceptHeader(this);
  }
