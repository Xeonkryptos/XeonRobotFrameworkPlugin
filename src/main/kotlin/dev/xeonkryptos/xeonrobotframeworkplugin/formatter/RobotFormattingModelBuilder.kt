...
class RobotFormattingModelBuilder : CustomFormattingModelBuilder {
    ...
    private fun createSpaceBuilder(codeStyleSettings: CodeStyleSettings): SpacingBuilder {
        ...
        return SpacingBuilder(codeStyleSettings, RobotLanguage.INSTANCE)
            ...
            .spaces(customSettings.SPACES_AFTER_VARIABLE_STATEMENT_ASSIGNMENT)
            ...
            .spaces(customSettings.SPACES_BETWEEN_KEYWORD_CALL_AND_ARGUMENTS)
            .after(RobotTokenSets.LOCAL_SETTING_NAMES_SET)
            .spaces(customSettings.SPACES_AFTER_LOCAL_SETTING_NAME)
