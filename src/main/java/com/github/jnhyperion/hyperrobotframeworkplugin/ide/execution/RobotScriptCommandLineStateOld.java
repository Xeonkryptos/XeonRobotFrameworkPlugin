...
//
//public class RobotScriptCommandLineStateOld extends PythonScriptCommandLineState {
//
...
//
//    public RobotScriptCommandLineStateOld(RobotRunConfiguration robotRunConfiguration, @NotNull ExecutionEnvironment env) {
