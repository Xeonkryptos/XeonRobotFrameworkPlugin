...
public class RobotExtendedTrySyntaxImpl extends ASTWrapperPsiElement implements RobotExtendedTrySyntax {

  public RobotExtendedTrySyntaxImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotVisitor visitor) {
    visitor.visitExtendedTrySyntax(this);
  }
