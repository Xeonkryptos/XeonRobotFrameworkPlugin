...
public class RobotTestCaseStepImpl extends ASTWrapperPsiElement implements RobotTestCaseStep {

  public RobotTestCaseStepImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotVisitor visitor) {
    visitor.visitTestCaseStep(this);
  }
