...
public class RobotTasksSectionImpl extends ASTWrapperPsiElement implements RobotTasksSection {
  ...
  @Override
  @NotNull
  public RobotTasksHeader getTasksHeader() {
    return findNotNullChildByClass(RobotTasksHeader.class);
  }
