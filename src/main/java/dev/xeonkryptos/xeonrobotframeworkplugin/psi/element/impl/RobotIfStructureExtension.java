...
public abstract class RobotIfStructureExtension extends RobotExecutableStatementImpl implements RobotIfStructure {

    public RobotIfStructureExtension(@NotNull ASTNode node) {
        super(node);
    }
