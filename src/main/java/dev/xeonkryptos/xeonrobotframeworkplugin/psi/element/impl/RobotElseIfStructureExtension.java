...
public abstract class RobotElseIfStructureExtension extends RobotExecutableStatementImpl implements RobotElseIfStructure {

    public RobotElseIfStructureExtension(@NotNull ASTNode node) {
        super(node);
    }
