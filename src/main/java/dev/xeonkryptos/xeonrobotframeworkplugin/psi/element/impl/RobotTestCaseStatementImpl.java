...
public class RobotTestCaseStatementImpl extends ASTWrapperPsiElement implements RobotTestCaseStatement {
  ...
  @Override
  @NotNull
  public RobotTestCaseName getTestCaseName() {
    return findNotNullChildByClass(RobotTestCaseName.class);
  }

  @Override
  @NotNull
  public List<RobotTestCaseStep> getTestCaseStepList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RobotTestCaseStep.class);
  }
