...
public class RobotSettingValueImpl extends ASTWrapperPsiElement implements RobotSettingValue {

  public RobotSettingValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotVisitor visitor) {
    visitor.visitSettingValue(this);
  }
