...
public class RobotTestCasesSectionImpl extends ASTWrapperPsiElement implements RobotTestCasesSection {
  ...
  @Override
  @NotNull
  public RobotTestCasesHeader getTestCasesHeader() {
    return findNotNullChildByClass(RobotTestCasesHeader.class);
  }
