...
public class RobotSpaceSeparatedStatementImpl extends ASTWrapperPsiElement implements RobotSpaceSeparatedStatement {

  public RobotSpaceSeparatedStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotVisitor visitor) {
    visitor.visitSpaceSeparatedStatement(this);
  }
